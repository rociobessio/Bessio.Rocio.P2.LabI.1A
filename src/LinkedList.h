 ...
 * @brief Agrega valores aleatorios a la lista creando una nueva
 *
 * @param this
 * @param pFunc
 * @return linkedList* lista ya mappeada
 */
LinkedList* ll_map(LinkedList* this, void* (*pFunc)(void* element));

/**
 * @fn int ll_sortBy2Func(LinkedList*, int(*)(void*, void*), int(*)(void*, void*), int)
 * @brief Hace un sort, por criterio y ademas si hay coincidencias en la primer pFunc ordena por la segunda pFunc2
 *
 * @param this
 * @param pFunc
 * @param pFunc2
